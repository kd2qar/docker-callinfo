...
test5: build
	callinfo --refresh 5V1JE 5V22FF 5V23LE 5V7A 5V7AA  5V7AD 5V7AK 5V7AS 5V7BB 5V7BD 5V7BJ 5V7BR 5V7C 5V7CC 5V7D 5V7DB 5V7DP 5V7DX 5V7EI 5V7FA 5V7FL 5V7FMD 5V7GD 5V7HR 5V7JD  5V7JG 5V7JH 5V7KS 5V7MA 5V7MAR 5V7MAS 5V7MB 5V7MI 5V7MN 5V7MP 5V7NW 5V7P 5V7PK 5V7PM 5V7PRF 5V7PS 5V7RF 5V7RU 5V7RV 5V7SA 5V7SE 5V7SGA 5V7SI 5V7SM 5V7TD 5V7TH 5V7TT 5V7UF 5V7V 5V7VJ 5V7XO 5V7Z 5V7ZA 5V7ZZ --nosql
test6: build
