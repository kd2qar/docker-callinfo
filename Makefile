...
test2: build
	...
	./callinfo NJ1Q
	./callinfo NJ1Q --table rcforb.rawny_details | mariadb
	./callinfo NJ1Q --table rcforb.rawny_details| mariadb
...
test8: build
	callinfo --table rcforb.rawny_details --refresh co2oq iz7ddc iz8dmz ac7av kk6mu py2wdx sq5hg vk2ly wa3ptf | mariadb
test9: build
...
test: build test1 test2 test3 test4 test5 test6 test7 test8 test9
	@echo "test"
	@echo "delete FROM rcforb.rawny_details where callsign = 'w1aw';delete FROM fieldday.qrzdata where fdcall = 'w1aw';" | mariadb
	./callinfo w1aw -t rcforb.rawny_details | mariadb
	./callinfo -t fieldday.qrzdata w1aw | mariadb
	./callinfo --table rcforb.rawny_details w1aw | mariadb
	./callinfo -t fieldday.qrzdata w1aw | mariadb
	@echo "delete FROM rcforb.rawny_details where callsign = 'w1aw';delete FROM fieldday.qrzdata where fdcall = 'w1aw';" | mariadb
	./callinfo --noqrz w1aw
	./callinfo --noqrz -t fieldday.qrzdata w1aw | mariadb
	./callinfo --noqrz --table rcforb.rawny_details | mariadb
	./callinfo --noqrz -t fieldday.qrzdata w1aw | mariadb
